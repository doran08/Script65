...
-- Instances: 139 | Scripts: 31 | Modules: 5
...
G2L["88"] = Instance.new("TextLabel", G2L["5a"]);
...
G2L["88"]["BackgroundColor3"] = Color3.fromRGB(51, 51, 51);
...
G2L["88"]["Size"] = UDim2.new(0, 399, 0, 50);


G2L["88"]["Text"] = [[Current: ]];


G2L["88"]["Name"] = [[Currentfps]];


G2L["88"]["Font"] = Enum.Font.SourceSans;


G2L["88"]["Position"] = UDim2.new(0.004842615220695734, 0, 0.7800480723381042, 0);
